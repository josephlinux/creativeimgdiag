...
$sql6="Select mrdnumber,name,refdoctor,testname,cost,discount,testname,category,refamount,age,gender,phone,tnumber,user,raddiscount from dataentry where date between '$date1' and '$date2' and id='$id'";
...
<td><center> $refamt</td>
<td><center><a href='refupdaterrecord.php?tnumber=$tnumber'><i class='far fa-edit'></i>Edit</a></td>
