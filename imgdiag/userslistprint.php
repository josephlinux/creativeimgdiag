...
$pdf->Ln(1);
$pdf->Cell(50);
$pdf->Cell(100,8,"LOGIN USERS LIST",0,1,'C',1);
...
$pdf->Cell(60,5,"Name",1,0,'C',1);
$pdf->Cell(50,5,"Username",1,0,'C',1);
$pdf->Cell(50,5,"User Type",1,1,'C',1);

$q=1;
	
	
$sql9="SELECT name,username,type from login where id='$id'";
$rs9=mysql_query($sql9) or die(mysql_error());
while($myrowc=mysql_fetch_row($rs9))
{      
 $name=strtoupper($myrowc[0]); $uname=($myrowc[1]);$type=($myrowc[2]);
...
$pdf->Cell(60,6,$name, 1, 0, 'L',0);
$pdf->Cell(50,6, $uname, 1, 0, 'L',0);
$pdf->Cell(50,6, $type, 1, 1, 'C',0);
