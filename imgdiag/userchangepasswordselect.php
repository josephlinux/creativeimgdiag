...
<table width=100%><tr><td align=right width=98%><font face="Arial">Welcome Mr./ Ms. : <?php echo $uu; ?>&nbsp;</td><td align=center> <img src="images/login.png" height=50 width=50></td></tr></table>
	...
	<form name=services action="userchangepasswordinsert.php" method="post" onSubmit="return validateForm();">
...
select {
  ...
  background-image: linear-gradient(to top, #f9f9f9, #fff 33%);
		...
		<p>&nbsp;</p>
		<p align="center"><b>Change Password From</b></p>
	<div align="center">
...
<td width="35%" bgcolor=" #f2f2f2" align="center" >
		...
		<input type="password" name="ppassword" size=40 ></td>
