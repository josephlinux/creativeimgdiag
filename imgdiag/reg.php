...
<center><font color=white size=6><?php echo $title; ?></font></center>
	...
	<br>
	 ...
	 <style>
		...
		<form name=ggh action=report.php method=post target="_blank">
	<?php
include('connection.php');
...
<div id="resultt">
         ...
         <td> <input type='text'  id='price'  placeholder=' Enter Discount'  /></td>
...
<input type=submit  value="Next to Submit" class='button' name=submit style="font-weight: 700">
	</p>
	<p>&nbsp;</p>
	<p>&nbsp;</p>
	</form>	
