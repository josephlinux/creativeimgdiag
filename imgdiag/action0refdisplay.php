...
function checkDelete(){
    return confirm('Are you sure to Clear Referal ?');
}
</script>
...
<table width=100%><tr><td align=right width=98%><font face="Arial">Welcome Mr./ Ms. : <?php echo $uu; ?>&nbsp;</td><td align=center> <img src="images/login.png" height=50 width=50></td></tr></table>
	...
	<form name=img action="action0refaction.php" method="post">
...
echo"<input type='hidden' name='date1' value='$date1'><input type='hidden' name='date1' value='$date1'>";
...
<center>
  <button type='submit' class='button' onclick='return checkDelete()'>
								<p style='text-align: left'>
								<font face='MS Serif' size='4'> 
								TAKE ACTION</font></button>
