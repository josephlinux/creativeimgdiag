...
select {
  ...
  background-image: linear-gradient(to top, #f9f9f9, #fff 33%);
		...
		<p>&nbsp;</p>
		<p align="center"><font size="4"><b> Update Referal Date Selection 
		Form</b></p>
	<div align="center">
...
<input type=hidden name=user value='<?php echo $uu; ?>'>
			...
			if($date !='')
			{
			$sql1="update refdate set date='$date'";
            $rs1=mysql_query($sql1);

			echo "<font color=green size=4>Date Updated Secuccfully</font>";
			
			echo"<script>
         setTimeout(function(){
            window.location.href = 'reftodayupdatedrecordlistdisplay.php';
         }, 2000);
      </script>";
