...
{ 
 ...
 while(($csv = fgetcsv($file_open, 1000, ",")) !== false)
 {
  ...
  $tname=strtoupper($test);
    $cate=strtoupper($catee);

  if($test !="testname")
  {
  mysql_query("INSERT INTO tests(id,category,testname,cost) VALUES ('$id','$cate','$tname','$cost')");
  }
...
?> 
		...
		<p>&nbsp;Template for Import Tests : <a href="tests_template.csv">Click here</a><p>&nbsp;<p>&nbsp;<form method="post" action="#" enctype="multipart/form-data">
