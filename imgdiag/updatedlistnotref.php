...
$sql6="Select mrd,name,doctor,test,cost,discount,raddis,date,code,category,refamt,tnumber,user from modi where date between '$date1' and '$date2' and id='$id' and user !='referal'";
...
$sql9="Select mrd,name,doctor,test,cost,discount,raddis,date,code,category,refamt,tnumber,user from updates where tnumber='$tnumber' and id='$id' and user !='referal'";
