...
echo "<table id=customers><th colspan=50 bgcolor=wheat><font color=white  size=4 ><b><center>TRANSACTIONS LIST ($date)</th>
 <tr>
<th><b><center>S.No</th>
...
$sql6="Select mrdnumber,name,refdoctor,testname,cost,discount,testname,category,refamount,age,gender,phone,tnumber,user,raddiscount from dataentry where date='$date' and id='$id'";
...
<td><center> $refamt</td>
<td><center><a href='reftodayupdaterrecord.php?tnumber=$tnumber'><i class='far fa-edit'></i>Edit</a></td>
