...
$sql6="Select date,name,refdoctor,age,gender,phone,address from dataentry where mrdnumber='$mrd' and id='$id' and user='$uu'";
...
$sql9="SELECT testname,cost,discount,raddiscount FROM dataentry where mrdnumber='$mrd' and id='$id' and user='$uu'";
