...
<table width=100%><tr><td align=right width=98%><font face="Arial">Welcome Mr./ Ms. : <?php echo $uu; ?>&nbsp;</td><td align=center> <img src="images/login.png" height=50 width=50></td></tr></table>
	...
	<form name=img action="catecumutestsreport.php" method="post" target="_blank">
...
select {
  ...
  background-image: linear-gradient(to top, #f9f9f9, #fff 33%);
		...
		<p>&nbsp;</p>
		<p align="center"><font size="4"><b>Cumulative Test's All Details Selection Form</b></p>
	<div align="center">
	<table border="1" width="41%" cellpadding="10" style="border-collapse: collapse" height="102">
...
<td width="81%" bgcolor=" #f2f2f2" align="center" colspan="3" >
                <font size="4">
                <b>
