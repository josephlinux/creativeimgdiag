...
$sql6="Select mrdnumber,name,refdoctor,testname,cost,discount,testname,category,refamount,age,gender,phone,tnumber,user,date from dataentry where date between '$date1' and '$date2' and id='$id' and refamount=''";
