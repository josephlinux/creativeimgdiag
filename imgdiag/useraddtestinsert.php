...
$sql6="insert into tests(sno,category,testname,cost,id)values('$sno','$category','$name','$cost','$id')";
$rs6=mysql_query($sql6) or die(mysql_error());

echo"<center><font color=green size=4><b>Test Added Sucessfully";
