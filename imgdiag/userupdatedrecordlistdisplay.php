...
echo "<table id=customers><th colspan=50 bgcolor=wheat><font color=white  size=4 ><b><center>TRANSACTIONS LIST($date1 to $date2) OF USER ($uu)</th>
 <tr>
<th><b><center>S.No</th>
...
$sql6="Select mrdnumber,name,refdoctor,testname,cost,discount,testname,category,refamount,age,gender,phone,tnumber,user,raddiscount from dataentry where date between '$date1' and '$date2' and id='$id' and user='$uu'";
...
<td><center> $refamt</td>
<td><center><a href='userupdaterrecord.php?tnumber=$tnumber'><i class='far fa-edit'></i>Edit</a></td>
