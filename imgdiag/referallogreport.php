...
$pdf->Ln(1);
$pdf->Cell(50);
$pdf->Cell(100,8,"$uu USER LOGIN HISTORY LIST From $date1 to $date2",0,1,'C',1);
...
$sql9="SELECT user,login,ip,date from userlog where id='$id' and date between '$date1' and '$date2' and user='$uu'";
