...
a:link {
  text-decoration: none;
	...
	<div id="header">
<center><table border=0><td><img src="images/logo.png" height=80 width=80></td><td><font color=white size=6>CREATIVE IMAGING AND DIAGNOSTIC BILLING SOFTWARE</font></td></tr></table>
<p>&nbsp;</p>
		</center>
...
<body>
		...
		<p>&nbsp;</p>
		<p align="center"><b><font color="#FF0000">You are enter Wrong Username 
		(or) Password Plz Try it Again..</font></b></p>
<div class="container">
	<section id="content">
		<form name=xx action="welcome.php" method=post>
			<h1>Login Form</h1>
			<div>
			...
			<div>
				...
				<input type="submit" value="Log in" style="float: center" />
				
			</div>
		</form><!-- form -->
		<div class="button">
			<a href="#">Welcome to Login</a>
		</div><!-- button -->
	</section><!-- content -->
</div><!-- container -->
</body>
