...
<table width=100%><tr><td align=right width=98%><font face="Arial">Welcome Mr./ Ms. : <?php echo $uu; ?>&nbsp;</td><td align=center> <img src="images/login.png" height=50 width=50></td></tr></table>
	...
	<form name=img action="monthlyreport.php" method="post" target="_blank">
...
select {
  ...
  background-image: linear-gradient(to top, #f9f9f9, #fff 33%);
		...
		<p>&nbsp;</p>
		<p align="center"><b><font size="4">Monthly Reports Selection Form</font></b></p>
	<div align="center">
...
<td width="19%" bgcolor=" #f2f2f2" align="center" >
...
<td width="35%" bgcolor=" #f2f2f2" align="center" colspan="2" >
<div class="content">

<input type="text" size="60" class="search" id="searchid" name="searchid" placeholder="Type 'ALL' for All Doctors" >
<div id="result">
</div>
</div>
</td>
...
<td width="35%" bgcolor=" #f2f2f2" align="center" colspan="2" ><?php echo"<select style='font-family: ARIAL; text-transform:  font-weight: bold;' size='1' name=category ><option>ALL</option>";
