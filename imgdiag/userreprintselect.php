...
<table width=100%><tr><td align=right width=98%><font face="Arial">Welcome Mr./ Ms. : <?php echo $uu; ?>&nbsp;</td><td align=center> <img src="images/login.png" height=50 width=50></td></tr></table>
	...
	<form name=img action="userreprintreceipt.php" method="post" target=_blank>
...
select {
  ...
  background-image: linear-gradient(to top, #f9f9f9, #fff 33%);
		...
		<p>&nbsp;</p>
		<p align="center"><font size="4"><b> Reprint Receipt Selection 
		Form</b></p>
	<div align="center">
	<table border="1" width="33%" cellpadding="10" style="border-collapse: collapse" height="102">


<tr>
<td width="20%" bgcolor=" #f2f2f2">
Enter Bill Number</td>


<td width="30%" bgcolor=" #f2f2f2" align="center" >
<font size="4">
<input type="text" name="mrdnumber" placeholder="Enter Bill Number" required></td>
