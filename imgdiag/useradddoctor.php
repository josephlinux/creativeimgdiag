...
<table width=100%><tr><td align=right width=98%><font face="Arial">Welcome Mr./ Ms. : <?php echo $uu; ?>&nbsp;</td><td align=center> <img src="images/login.png" height=50 width=50></td></tr></table>
	...
	<form name=img action="useradddoctorinsert.php" method="post">
...
.button5 {background-color: #555555;} /* Black */
	...
	?>
		...
		<p>&nbsp;</p>
		<p align="center"><b>Doctor Enroll Form</b></p>
	<div align="center">
	<table border="1" width="42%" cellpadding="10" style="border-collapse: collapse">


<tr>
<td width="29%" bgcolor="#f2f2f2">
<p align="center">Doctor Name :</td>


<td width="63%" bgcolor=" #f2f2f2" align="left" >
...
<td width="29%" bgcolor=" #f2f2f2" align="center" >
Hospital Name :</td>


<td width="63%" bgcolor=" #f2f2f2" align="left" >
		<input type="text" name="hospital" size="40" required></td>
...
<td width="63%" bgcolor=" #f2f2f2" align="left" >
<input type="text" name="phone" size="40" required></td>
...
<td width="63%" bgcolor=" #f2f2f2" align="center" >
<p align="left">
<textarea rows="4" name="address" cols="42" required></textarea></td>
