...
<input type="text" size="60" class="search" id="searchid" name="searchid" placeholder="Type Doctors Name" >
<div id="result">
</div>
</div>
</td>
...
<div class="content">
<td width="25%" bgcolor=" #f2f2f2" align="center" >
<input type="text" size="60" class="search2" id="searchid2" name="searchid2" placeholder="Type Test Name" >
<div id="result2">
</div>
</div>
</td>
...
$rd=mysql_query($sql3);
 	...
 	echo"<script>
         setTimeout(function(){
            window.location.href = 'refaddreferal.php';
         }, 1000);
      </script>";
