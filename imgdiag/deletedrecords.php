...
$pdf->Cell(60,5," DELETED RECORDS REPORT ($date1 to $date2)",0,1,'C',1);
...
$pdf->Cell(20,5," NETAMOUNT",1,1,'C',1);


$sql6="Select mrdnumber,name,refdoctor,testname,cost,discount,raddiscount,date from deletelist  where date between '$date1' and '$date2' and id='$id'";
...
$sql7="Select mrdnumber from deletelist  where date between '$date1' and '$date2' and id='$id' and mrdnumber='$mrd'";
$rs7=mysql_query($sql7) or die(mysql_error());
while($myrowc=mysql_fetch_row($rs7))
 {
$m=strtoupper($myrowc[0]);
$t++;
}

$sql8="Select remark from deleteremarks  where  id='$id' and mrdnumber='$mrd'";
