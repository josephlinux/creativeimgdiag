...
<table width=100%><tr><td align=right width=98%><font face="Arial">Welcome Mr./ Ms. : <?php echo $uu; ?>&nbsp;</td><td align=center> <img src="images/login.png" height=50 width=50></td></tr></table>
	...
	<form name=img action="userreturndisplayrecords.php" method="post">
...
.button5 {background-color: #555555;} /* Black */
	...
	?>
		...
		<p>&nbsp;</p>
		<p align="center"><b><font size="4">Returns Select Form</b></p>
	<div align="center">
...
<p align="center" face=arial>Enter Bill Number :</td>


<td width="39%" bgcolor=" #f2f2f2" align="center" >
<input type="text" name="mrdnumber" class="search" required></td>
