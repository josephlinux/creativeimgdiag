...
<table width=100%><tr><td align=right width=98%><font face="Arial">Welcome Mr./ Ms. : <?php echo $uu; ?>&nbsp;</td><td align=center> <img src="images/login.png" height=50 width=50></td></tr></table>
	...
	<form name=img action="admindaywisecumreport.php" method="post" target="_blank">
...
select {
  ...
  background-image: linear-gradient(to top, #f9f9f9, #fff 33%);
		...
		<p>&nbsp;</p>
		<p align="center"><b><font size="4">Day/Monthly User wise Select Form</font></b></p>
	<div align="center">
...
<td width="47%" bgcolor=" #f2f2f2" align="center" colspan="2" ><?php echo"<select style='font-family: ARIAL; text-transform:  font-weight: bold;' size='1' name=usr ><option>ALL</option>";
