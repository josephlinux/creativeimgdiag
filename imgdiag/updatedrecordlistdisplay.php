...
echo "<table id=customers><th colspan=50 bgcolor=wheat><font color=white  size=4 ><b><center>TRANSACTIONS LIST($date1 to $date2)</th>
 <tr>
<th><b><center>S.No</th>
<th><b><center>DATE</th>
...
<th><b><center>RAD DISC.</th>
<th><b><center>REF AMOUNT</th>
<td bgcolor=red><font color=white>ACTION</td></tr>";


$sql6="Select mrdnumber,name,refdoctor,testname,cost,discount,testname,category,refamount,age,gender,phone,tnumber,user,raddiscount,date from dataentry where date between '$date1' and '$date2' and id='$id'";
...
$age=strtoupper($myrowc[9]);$gender=strtoupper($myrowc[10]);$phone=strtoupper($myrowc[11]);$tnumber=strtoupper($myrowc[12]);$user=strtoupper($myrowc[13]);$raddisc=strtoupper($myrowc[14]);
$date=strtoupper($myrowc[15]);
...
<td><center> $raddisc</td>
<td><center> $refamt</td>
<td><center><a href='updaterrecord.php?tnumber=$tnumber'><i class='far fa-edit'></i>Edit</a></td>
