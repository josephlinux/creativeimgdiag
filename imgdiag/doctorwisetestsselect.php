...
<table width=100%><tr><td align=right width=98%><font face="Arial">Welcome Mr./ Ms. : <?php echo $uu; ?>&nbsp;</td><td align=center> <img src="images/login.png" height=50 width=50></td></tr></table>
	...
	<form name=img action="doctorwisetestreport.php" method="post" target="_blank">
...
select {
  ...
  background-image: linear-gradient(to top, #f9f9f9, #fff 33%);
		...
		<p>&nbsp;</p>
		<p align="center"><b>D<font size="4">octor wise tests Reports Selection Form</font></b></p>
	<div align="center">
	<table border="1" width="47%" cellpadding="10" style="border-collapse: collapse">
