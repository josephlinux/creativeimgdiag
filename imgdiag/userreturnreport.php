...
$pdf->Cell(60,5," RETURNS REPORT ($date1 to $date2) OF USER: $uu",0,1,'C',1);
...
$sql6="Select mrdnumber,name,refdoctor,testname,cost,discount,raddiscount,date from returns  where date between '$date1' and '$date2' and id='$id' and user='$uu'";
