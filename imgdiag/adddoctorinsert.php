...
$sql2="insert into doctor(doctorname,hospital,phone,address,did,id)values('$name','$hospital','$phone','$address','$did','$id')";
$rd=mysql_query($sql2);

echo"<center><font color=green size=4>Doctor Enroll sucesfully";
