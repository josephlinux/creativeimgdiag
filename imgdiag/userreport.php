...
values('$mrd','$date','$pname','$age','$gender','$mobile','$address','$doctor','$cate','$tname','$cost','$disc','$raddisc','$refamt','$uu','$did','$id','$mode')";
$rd=mysql_query($sql7);

$bdate=$date;
}

$sql8="delete FROM dummy where name='$pname' and user='$uu' and id='$id'";
$rd=mysql_query($sql8);
...
$pdf->Ln(1);
$pdf->Cell(50);
$pdf->Cell(100,5,"$address2",0,1,'C',1);
...
$cell_width = 50;
$current_x = $pdf->GetX();
$pdf->MultiCell($cell_width, 5, $bdate, 0, Alignment.LEFT, true);
...
$pdf->Cell(8,6,"S.no",1,0,'C',1);
$pdf->Cell(65,6,"Test Name",1,0,'C',1);
$pdf->Cell(30,6,"Cost",1,0,'C',1);
if($d !=0)
{
$pdf->Cell(20,6,"Discount",1,0,'C',1);
}
if($rd !=0)
{
$pdf->Cell(25,6,"Rad.Discount",1,0,'C',1);
}

$pdf->Cell(22,6," Netamount",1,1,'C',1);
...
$pdf->Cell(8,7, $q, 1, 0, 'C',0);
$pdf->Cell(65,7,$test, 1, 0, 'C',0);
$pdf->Cell(30,7, $cst, 1, 0, 'C',0);
if($d !=0)
{
$pdf->Cell(20,7, $discc, 1, 0, 'C',0);
}
if($rd !=0)
{
$pdf->Cell(25,7, $raddiscc, 1, 0, 'C',0);
}
