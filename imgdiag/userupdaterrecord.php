...
<table width=100% ><tr><td align=right width=98%><font face="Arial">Welcome Mr./ 
  ...
  <form name=main action=userupdateinsert.php   method=POST>
...
$sql6="Select mrdnumber,name,refdoctor,testname,cost,discount,raddiscount,date,category,refamount from dataentry where tnumber='$tnumber' and id='$id' and user='$uu'";
