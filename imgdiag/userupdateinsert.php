...
$tnum='';
 $sql9="select tnumber from modi where tnumber='$tnumber' and id='$id' and user='$uu'";
...
$sql6="update dataentry set mrdnumber='$mrd',name='$name',refdoctor='$searchid',did='$did',category='$category',testname='$searchid2',cost='$cost',discount='$discount',refamount='$refamt',raddiscount='$raddis',date='$date' where tnumber='$tnumber' and id='$id' and user='$uu'";
$rd=mysql_query($sql6);
