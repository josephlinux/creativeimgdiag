...
if ($did !='')
{
$sql6="insert into deletedoctor(select * from doctor where did='$did')";
$rs6=mysql_query($sql6) or die(mysql_error());




$sql7="delete from doctor where did='$did'";
$rs7=mysql_query($sql7) or die(mysql_error());

echo"<br><br><font color=green size=4><b>Doctor Deleted Sucessfully...";
