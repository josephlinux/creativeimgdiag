...
$sql6="insert into login(name,username,password,type,id)values('$name','$user','$password','$usertype','$id')";
$rs6=mysql_query($sql6) or die(mysql_error());

echo"<center><font color=green size=4><b>User Created Sucessfully";
?>		
